...
const SkillsContainer: FC<ISkillsContainerProps> = ({data , label}) => {
    return <article className='min-h-[25rem] border border-primary rounded-lg' >
        <h2 className='capitalize text-primary text-2xl font-semibold py-4 px-6 border-b border-primary' >{label}</h2>
