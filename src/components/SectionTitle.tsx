...
const SectionTitle: FC<ISectionTitleProps> = ({title , description , className , ...props}) => {
    return <div className={cn("flex flex-col   gap-y-1 md:gap-y-2 items-center capitalize",  className)} {...props} >
